 ...
 */
public class InjectPrimaryTypeExtrasFragment4Test extends ActivityInstrumentationTestCase2<TestExtraOnFragment4Activity> {

    public InjectPrimaryTypeExtrasFragment4Test() {
        super(TestExtraOnFragment4Activity.class);
    }
